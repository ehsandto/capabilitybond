...
**Evidence:** add the public GitHub repository, StudioNet contract, deployment transaction, both finalized profile transactions, and—only when available—a successful finalized live `challenge_capability` transaction.
